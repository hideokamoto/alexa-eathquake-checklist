...
const LaunchRequestHandler = {
  ...
  handle (handlerInput) {
    ...
    const speechText = getRandomMessage(questions)
...
const AskPrepareIntent = {
  ...
  handle (handlerInput) {
    const messages = [
      '「人と防災未来センター」にて、減災グッズチェックリストが公開されています。救援物資が届くまでの３日間程度を自足してしのぐための備えが紹介されているのでぜひ見てみてください。',
    ...
    const speechText = getRandomMessage(messages)
...
const CancelAndStopIntentHandler = {
  ...
  handle (handlerInput) {
    const speechText = getRandomMessage(exitMessages)
